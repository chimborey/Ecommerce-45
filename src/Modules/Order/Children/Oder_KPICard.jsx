import { OrderKPICard } from "../../../Data/Dashboard/OrderData"



export default function Order_KPICard() {
      return (
            <section className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
                  {
                        OrderKPICard.map((item) => {
                                    ...
                                    <div className=" w-full overflow-hidden flex flex-col space-y-3 py-3 px-3 hover:shadow-md hover:backdrop-blur-md border-t-4 border-t-green-500 rounded-lg bg-white border-gray-100 border transition-all duration-300">
                                          ...
                                          <div className=" flex justify-between">
                                                ...
                                                <div className=" flex flex-col space-y-3">
                                                      ...
                                                      <h3 className=" text-xs text-gray-500 uppercase">{name}</h3>

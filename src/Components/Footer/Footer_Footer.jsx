...
export default function Footer_Footer() {
      return (
            <section className="w-full h-[77vh] overflow-hidden bg-center bg-cover bg-no-repeat object-center object-cover" style={{ backgroundImage: `url(${freshbite_footer_bg})` }}>
                  ...
                  <main className="container max-w-7xl mx-auto px-4 relative z-10">
                        <div className="flex flex-col space-y-12">
                              ...
                              {/* Newsletter Banner */}
                              <div
                                    className="w-full h-72 md:h-64 rounded-2xl flex flex-col items-center justify-center bg-center bg-cover bg-no-repeat relative overflow-hidden shadow-md px-4"
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-4">
                                    ...
                                    <div className="flex flex-col space-y-3">
                                          <h4 className="text-sm font-bold text-gray-800 uppercase tracking-wider">My Account</h4>
                                          <ul className="space-y-2 text-xs text-gray-600">
                                                <li><Link to="/account" className="hover:text-emerald-600 transition-colors">My Account</Link></li>
                                                <li><Link to="/cart" className="hover:text-emerald-600 transition-colors">My Cart</Link></li>
                                                <li><Link to="/orders" className="hover:text-emerald-600 transition-colors">Order History</Link></li>
                                                <li><Link to="/returns" className="hover:text-emerald-600 transition-colors">Return Policy</Link></li>
                                          </ul>
                                    </div>

                                    {/* Column 3: Our Legal & Quick Links */}
                                    <div className="flex flex-col space-y-3">
                                          ...
                                          <ul className="space-y-2 text-xs text-gray-600">
                                                ...
                                                <li><Link to="/accessibility" className="hover:text-emerald-600 transition-colors">Accessibility</Link></li>
                                                <li><Link to="/about" className="hover:text-emerald-600 transition-colors">About Us</Link></li>
                                                <li><Link to="/track-order" className="hover:text-emerald-600 transition-colors">Track Order</Link></li>
                                                <li><Link to="/stores" className="hover:text-emerald-600 transition-colors">Store Location</Link></li>
                                          </ul>
                                    </div>

                                    {/* Column 4: Information */}
                                    <div className="flex flex-col space-y-3">
                                          <h4 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Information</h4>
                                          <ul className="space-y-2 text-xs text-gray-600">
                                                <li><Link to="/story" className="hover:text-emerald-600 transition-colors">Our Story</Link></li>
                                                <li><Link to="/contact" className="hover:text-emerald-600 transition-colors">Keep in Touch</Link></li>
                                                <li><Link to="/privacy" className="hover:text-emerald-600 transition-colors">Privacy Policy</Link></li>
                                                <li><Link to="/faq" className="hover:text-emerald-600 transition-colors">FAQ's</Link></li>
                                          </ul>
                                    </div>

                                    {/* Column 5: Contact Details */}
                                    <div className="flex flex-col space-y-3">
                                          <h4 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Contact Us</h4>
                                          <ul className="space-y-2.5 text-xs text-gray-600">
                                                ...
                                                <li className="flex items-start gap-2">
                                                      <FaMapMarkerAlt className="text-emerald-600 shrink-0 mt-0.5" />
